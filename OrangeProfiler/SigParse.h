...
private:
    ...
    bool ParseTypeDefOrRefEncoded(sig_index_type *pOutIndexType, sig_index *pOutIndex, mdToken * pUncompressedTok = NULL);
...
protected:
    ...
    virtual void NotifyTypeDefOrRef(sig_index_type  indexType, int index, mdToken mdTok = NULL) {}
    ...
    virtual void NotifyTypeGenericInst(sig_elem_type elem_type, sig_index_type indexType, sig_index index, sig_mem_number number, mdToken mdTok = NULL) {}
